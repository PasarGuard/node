...
const file_common_service_proto_rawDesc = "" +
	...
	"\x06target\x18\x02 \x01(\tR\x06target*3\n" +
	"\vBackendType\x12\b\n" +
	"\x04XRAY\x10\x00\x12\r\n" +
...
var file_common_service_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_common_service_proto_goTypes = []any{
	...
	(*Mtproto)(nil),                       // 22: service.Mtproto
	(*Proxy)(nil),                         // 23: service.Proxy
	(*User)(nil),                          // 24: service.User
	(*Users)(nil),                         // 25: service.Users
	(*UsersChunk)(nil),                    // 26: service.UsersChunk
	(*RoutingRule)(nil),                   // 27: service.RoutingRule
	(*RoutingRulesResponse)(nil),          // 28: service.RoutingRulesResponse
	(*BalancerInfoRequest)(nil),           // 29: service.BalancerInfoRequest
	(*BalancerInfoResponse)(nil),          // 30: service.BalancerInfoResponse
	(*TestRouteRequest)(nil),              // 31: service.TestRouteRequest
	(*RouteResult)(nil),                   // 32: service.RouteResult
	(*AddRoutingRuleRequest)(nil),         // 33: service.AddRoutingRuleRequest
	(*RemoveRoutingRuleRequest)(nil),      // 34: service.RemoveRoutingRuleRequest
	(*OverrideBalancerTargetRequest)(nil), // 35: service.OverrideBalancerTargetRequest
	nil,                                   // 36: service.StatsOnlineIpListResponse.IpsEntry
	nil,                                   // 37: service.TestRouteRequest.AttributesEntry
}
var file_common_service_proto_depIdxs = []int32{
	...
	36, // 4: service.StatsOnlineIpListResponse.ips:type_name -> service.StatsOnlineIpListResponse.IpsEntry
	...
	22, // 12: service.Proxy.mtproto:type_name -> service.Mtproto
	...
	27, // 16: service.RoutingRulesResponse.rules:type_name -> service.RoutingRule
	37, // 17: service.TestRouteRequest.attributes:type_name -> service.TestRouteRequest.AttributesEntry
	...
	24, // 28: service.NodeService.SyncUser:input_type -> service.User
	25, // 29: service.NodeService.SyncUsers:input_type -> service.Users
	26, // 30: service.NodeService.SyncUsersChunked:input_type -> service.UsersChunk
	2,  // 31: service.NodeService.ListRoutingRules:input_type -> service.Empty
	29, // 32: service.NodeService.GetBalancerInfo:input_type -> service.BalancerInfoRequest
	31, // 33: service.NodeService.TestRoute:input_type -> service.TestRouteRequest
	33, // 34: service.NodeService.AddRoutingRule:input_type -> service.AddRoutingRuleRequest
	34, // 35: service.NodeService.RemoveRoutingRule:input_type -> service.RemoveRoutingRuleRequest
	35, // 36: service.NodeService.OverrideBalancerTarget:input_type -> service.OverrideBalancerTargetRequest
	3,  // 37: service.NodeService.Start:output_type -> service.BaseInfoResponse
	2,  // 38: service.NodeService.Stop:output_type -> service.Empty
	3,  // 39: service.NodeService.GetBaseInfo:output_type -> service.BaseInfoResponse
	5,  // 40: service.NodeService.GetLogs:output_type -> service.Log
	15, // 41: service.NodeService.GetSystemStats:output_type -> service.SystemStatsResponse
	14, // 42: service.NodeService.GetBackendStats:output_type -> service.BackendStatsResponse
	7,  // 43: service.NodeService.GetStats:output_type -> service.StatResponse
	13, // 44: service.NodeService.GetOutboundsLatency:output_type -> service.LatencyResponse
	9,  // 45: service.NodeService.GetUserOnlineStats:output_type -> service.OnlineStatResponse
	10, // 46: service.NodeService.GetUserOnlineIpListStats:output_type -> service.StatsOnlineIpListResponse
	2,  // 47: service.NodeService.SyncUser:output_type -> service.Empty
	2,  // 48: service.NodeService.SyncUsers:output_type -> service.Empty
	2,  // 49: service.NodeService.SyncUsersChunked:output_type -> service.Empty
	28, // 50: service.NodeService.ListRoutingRules:output_type -> service.RoutingRulesResponse
	30, // 51: service.NodeService.GetBalancerInfo:output_type -> service.BalancerInfoResponse
	32, // 52: service.NodeService.TestRoute:output_type -> service.RouteResult
	2,  // 53: service.NodeService.AddRoutingRule:output_type -> service.Empty
	2,  // 54: service.NodeService.RemoveRoutingRule:output_type -> service.Empty
	2,  // 55: service.NodeService.OverrideBalancerTarget:output_type -> service.Empty
