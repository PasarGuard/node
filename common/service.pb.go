...
type UsageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          StatType               `protobuf:"varint,1,opt,name=type,proto3,enum=service.StatType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UsageRequest) GetType() StatType {
	if x != nil {
		return x.Type
	}
	return StatType_Outbounds
...
func (x *UsageReceipt) GetCollectedAt() int64 {
	if x != nil {
...
func (x *UsageReceipt) GetStats() []*Stat {
	if x != nil {
		return x.Stats
	}
	return nil
...
func (x *UsageAck) GetType() StatType {
	if x != nil {
		return x.Type
	}
	return StatType_Outbounds
...
func (x *UsageAck) GetReceiptId() string {
	if x != nil {
		return x.ReceiptId
	}
	return ""
...
var file_common_service_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_common_service_proto_goTypes = []any{
	...
	(*UsageRequest)(nil),                  // 9: service.UsageRequest
	(*UsageReceipt)(nil),                  // 10: service.UsageReceipt
	(*UsageAck)(nil),                      // 11: service.UsageAck
	(*OnlineStatResponse)(nil),            // 12: service.OnlineStatResponse
	(*StatsOnlineIpListResponse)(nil),     // 13: service.StatsOnlineIpListResponse
	(*Latency)(nil),                       // 14: service.Latency
	(*LatencyRequest)(nil),                // 15: service.LatencyRequest
	(*LatencyResponse)(nil),               // 16: service.LatencyResponse
	(*BackendStatsResponse)(nil),          // 17: service.BackendStatsResponse
	(*SystemStatsResponse)(nil),           // 18: service.SystemStatsResponse
	(*Vmess)(nil),                         // 19: service.Vmess
	(*Vless)(nil),                         // 20: service.Vless
	(*Trojan)(nil),                        // 21: service.Trojan
	(*Shadowsocks)(nil),                   // 22: service.Shadowsocks
	(*Wireguard)(nil),                     // 23: service.Wireguard
	(*Hysteria)(nil),                      // 24: service.Hysteria
	(*Proxy)(nil),                         // 25: service.Proxy
	(*User)(nil),                          // 26: service.User
	(*Users)(nil),                         // 27: service.Users
	(*UsersChunk)(nil),                    // 28: service.UsersChunk
	(*RoutingRule)(nil),                   // 29: service.RoutingRule
	(*RoutingRulesResponse)(nil),          // 30: service.RoutingRulesResponse
	(*BalancerInfoRequest)(nil),           // 31: service.BalancerInfoRequest
	(*BalancerInfoResponse)(nil),          // 32: service.BalancerInfoResponse
	(*TestRouteRequest)(nil),              // 33: service.TestRouteRequest
	(*RouteResult)(nil),                   // 34: service.RouteResult
	(*AddRoutingRuleRequest)(nil),         // 35: service.AddRoutingRuleRequest
	(*RemoveRoutingRuleRequest)(nil),      // 36: service.RemoveRoutingRuleRequest
	(*OverrideBalancerTargetRequest)(nil), // 37: service.OverrideBalancerTargetRequest
	nil,                                   // 38: service.StatsOnlineIpListResponse.IpsEntry
	nil,                                   // 39: service.TestRouteRequest.AttributesEntry
}
var file_common_service_proto_depIdxs = []int32{
	...
	1,  // 4: service.UsageRequest.type:type_name -> service.StatType
	6,  // 5: service.UsageReceipt.stats:type_name -> service.Stat
	1,  // 6: service.UsageAck.type:type_name -> service.StatType
	38, // 7: service.StatsOnlineIpListResponse.ips:type_name -> service.StatsOnlineIpListResponse.IpsEntry
	14, // 8: service.LatencyResponse.latencies:type_name -> service.Latency
	19, // 9: service.Proxy.vmess:type_name -> service.Vmess
	20, // 10: service.Proxy.vless:type_name -> service.Vless
	21, // 11: service.Proxy.trojan:type_name -> service.Trojan
	22, // 12: service.Proxy.shadowsocks:type_name -> service.Shadowsocks
	23, // 13: service.Proxy.wireguard:type_name -> service.Wireguard
	24, // 14: service.Proxy.hysteria:type_name -> service.Hysteria
	...
	29, // 18: service.RoutingRulesResponse.rules:type_name -> service.RoutingRule
	39, // 19: service.TestRouteRequest.attributes:type_name -> service.TestRouteRequest.AttributesEntry
	...
	9,  // 27: service.NodeService.CollectUsage:input_type -> service.UsageRequest
	11, // 28: service.NodeService.AcknowledgeUsage:input_type -> service.UsageAck
	15, // 29: service.NodeService.GetOutboundsLatency:input_type -> service.LatencyRequest
	...
	26, // 32: service.NodeService.SyncUser:input_type -> service.User
	27, // 33: service.NodeService.SyncUsers:input_type -> service.Users
	28, // 34: service.NodeService.SyncUsersChunked:input_type -> service.UsersChunk
	2,  // 35: service.NodeService.ListRoutingRules:input_type -> service.Empty
	31, // 36: service.NodeService.GetBalancerInfo:input_type -> service.BalancerInfoRequest
	33, // 37: service.NodeService.TestRoute:input_type -> service.TestRouteRequest
	35, // 38: service.NodeService.AddRoutingRule:input_type -> service.AddRoutingRuleRequest
	36, // 39: service.NodeService.RemoveRoutingRule:input_type -> service.RemoveRoutingRuleRequest
	37, // 40: service.NodeService.OverrideBalancerTarget:input_type -> service.OverrideBalancerTargetRequest
	...
	18, // 45: service.NodeService.GetSystemStats:output_type -> service.SystemStatsResponse
	17, // 46: service.NodeService.GetBackendStats:output_type -> service.BackendStatsResponse
	7,  // 47: service.NodeService.GetStats:output_type -> service.StatResponse
	10, // 48: service.NodeService.CollectUsage:output_type -> service.UsageReceipt
	2,  // 49: service.NodeService.AcknowledgeUsage:output_type -> service.Empty
	16, // 50: service.NodeService.GetOutboundsLatency:output_type -> service.LatencyResponse
	12, // 51: service.NodeService.GetUserOnlineStats:output_type -> service.OnlineStatResponse
	13, // 52: service.NodeService.GetUserOnlineIpListStats:output_type -> service.StatsOnlineIpListResponse
	2,  // 53: service.NodeService.SyncUser:output_type -> service.Empty
	2,  // 54: service.NodeService.SyncUsers:output_type -> service.Empty
	2,  // 55: service.NodeService.SyncUsersChunked:output_type -> service.Empty
	30, // 56: service.NodeService.ListRoutingRules:output_type -> service.RoutingRulesResponse
	32, // 57: service.NodeService.GetBalancerInfo:output_type -> service.BalancerInfoResponse
	34, // 58: service.NodeService.TestRoute:output_type -> service.RouteResult
	2,  // 59: service.NodeService.AddRoutingRule:output_type -> service.Empty
	2,  // 60: service.NodeService.RemoveRoutingRule:output_type -> service.Empty
	2,  // 61: service.NodeService.OverrideBalancerTarget:output_type -> service.Empty
