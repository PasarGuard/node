...
const (
	...
	NodeService_CollectUsage_FullMethodName             = "/service.NodeService/CollectUsage"
	NodeService_AcknowledgeUsage_FullMethodName         = "/service.NodeService/AcknowledgeUsage"
...
type NodeServiceClient interface {
	...
	CollectUsage(ctx context.Context, in *UsageRequest, opts ...grpc.CallOption) (*UsageReceipt, error)
	AcknowledgeUsage(ctx context.Context, in *UsageAck, opts ...grpc.CallOption) (*Empty, error)
...
func (c *nodeServiceClient) CollectUsage(ctx context.Context, in *UsageRequest, opts ...grpc.CallOption) (*UsageReceipt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UsageReceipt)
	err := c.cc.Invoke(ctx, NodeService_CollectUsage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeServiceClient) AcknowledgeUsage(ctx context.Context, in *UsageAck, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, NodeService_AcknowledgeUsage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeServiceServer interface {
	...
	CollectUsage(context.Context, *UsageRequest) (*UsageReceipt, error)
	AcknowledgeUsage(context.Context, *UsageAck) (*Empty, error)
...
func (UnimplementedNodeServiceServer) CollectUsage(context.Context, *UsageRequest) (*UsageReceipt, error) {
	return nil, status.Error(codes.Unimplemented, "method CollectUsage not implemented")
}
func (UnimplementedNodeServiceServer) AcknowledgeUsage(context.Context, *UsageAck) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AcknowledgeUsage not implemented")
}
...
func _NodeService_CollectUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UsageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServiceServer).CollectUsage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_CollectUsage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).CollectUsage(ctx, req.(*UsageRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _NodeService_AcknowledgeUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UsageAck)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServiceServer).AcknowledgeUsage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_AcknowledgeUsage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).AcknowledgeUsage(ctx, req.(*UsageAck))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NodeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NodeService_CollectUsage_Handler,
		},
		{
			MethodName: "AcknowledgeUsage",
			Handler:    _NodeService_AcknowledgeUsage_Handler,
		},
		{
