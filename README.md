...
| `GetLogs()`            | `GET`,`/logs`              | `Empty`       | gRPC: (stream `Log`)<br/>REST API: (`LogList`) | This method is a long-polling connection in the REST protocol, but in gRPC, it provides a stream connection.                                                               |
